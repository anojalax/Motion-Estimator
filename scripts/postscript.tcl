...
report_timing -from [all_inputs] -max_paths 20 -to [all_registers -data_pins] > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt

report_timing -from [all_register -clock_pins] -max_paths 20 -to [all_registers -data_pins] > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt

report_timing -from [all_registers -clock_pins] -max_paths 20 -to [all_outputs] > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt

report_timing -from [all_inputs] -to [all_outputs] -max_paths 20 > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt
...
report_timing -from [all_registers -clock_pins] -to [all_registers -data_pins] -delay_type max > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt

read_parasitics -format SPEF /courses/engr852/engr852-59/ME/REPORTS/ICC/ME_Final_extracted.spef.min

report_timing -from [all_registers -clock_pins] -to [all_registers -data_pins] -delay_type min > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.rpt

# Reporting timing with capacitance and transition time at each level in the path

report_timing -transition_time -capacitance -nets -input_pins -from [all_registers -clock_pins] -to [all_registers -data_pins] > /courses/engr852/engr852-59/ME/REPORTS/POST/timing.tran.cap.rpt

# save your session and come back later if you chose to.
save_session /courses/engr852/engr852-59/ME/REPORTS/POST/ME_Final.session
